  ...
  return (
    <>
      <div className="max-w-10xl mx-auto p-2">
        <h1 className="text-3xl font-bold mb-6 text-center text-orange-600 mt-3">
          Contact Us
        </h1>

        <div className="flex flex-columns-2 gap-5">
          {/* Contact Form */}
          <div className="bg-white w-[30%] p-6 rounded-lg shadow-md">
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors w-100"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="w-[70%] bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="mb-6 text-black w-[80%]">
              Whether you have a question, a suggestion, or just want to say
              hello, feel free to reach out. Our team is always ready to assist
              you and will respond as soon as possible.
            </p>
            <div className="flex gap-2">
              {/* Email */}
              <div className="flex flex-col items-start p-4 bg-white  w-full sm:w-[48%] lg:w-1/4">
              ...
              <div className="flex flex-col items-start p-4 bg-white w-full sm:w-[48%] lg:w-1/4">
                <div className="flex flex-col items-center mb-2 space-y-1">
                  ...
                  <h4 className="font-semibold">Work Day</h4>
                </div>
                <div>
