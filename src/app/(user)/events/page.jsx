...
//   const pyramidRows = [
//     [{ type: "text", name: "Engagement", highlighted: true }],

//     [
//       { type: "image", src: "/images/img1.png" },
//       { type: "text", name: "Bridal Shower" },
//       { type: "text", name: "Wedding" },
//       { type: "image", src: "/images/img2.png" },
//     ],

//     [
//       { type: "text", name: "Birthday", highlighted: true },
//       { type: "text", name: "Baby Shower", highlighted: true },
//       { type: "text", name: "Private Party", highlighted: true },
//     ],

//     [
//       { type: "image", src: "/images/img3.png" },
//       { type: "text", name: "Corporate Events" },
//       { type: "text", name: "Business Meeting" },
//       { type: "text", name: "Art Gallery" },
//       { type: "image", src: "/images/img4.png" },
//     ],
//   ];

//   // Helper to create slug URL from name
...
//           {row.map((item, idx) =>
//             item.type === "text" ? (
//               <Link key={idx} href={`/events/${toSlug(item.id)}`} passHref>
//                 <Typography
//                   sx={{
