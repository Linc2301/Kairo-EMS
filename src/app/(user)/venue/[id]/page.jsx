...
// export default function VenuePage() {
//   const { id } = useParams(); // param from URL [id]
//   const [venue, setVenue] = useState(null);

//   useEffect(() => {
//     async function fetchVenue() {
//       try {
//         const res = await axios.get(`/api/venue/${id}`); // Make sure this matches your API route exactly
//         setVenue(res.data);
//       } catch (error) {
//         console.error("Failed to fetch venue", error);
//       }
...
//   if (!venue) {
//     return <Typography>Loading venue details...</Typography>;
//   }
